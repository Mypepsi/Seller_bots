...
class Mongo:
    def __init__(self, main_tg_info):
        ...
        if self.tg_info["bot name"] == 'Creator':
            ...
            self.creator_proxy_url = f"https://{self.get_key(self.creator_settings_general, 'proxy url')}"
            self.creator_proxy_global_time = self.get_key(self.creator_settings_general, 'proxy global time')
        ...
        # region Collection tm_seller_settings
            ...
            self.tm_site_url = f"https://{self.get_key(self.tm_settings_general, 'url')}"
            ...
            self.tm_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.tm_saleprice_bot_name = self.get_key(self.tm_settings_general, 'saleprice bot name')
        ...
        # region Collection waxpeer_seller_settings
            ...
            self.waxpeer_site_url = f"https://{self.get_key(self.waxpeer_settings_general, 'url')}"
            ...
            self.waxpeer_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.waxpeer_saleprice_bot_name = self.get_key(self.waxpeer_settings_general, 'saleprice bot name')
        ...
        # region Collection csgoempire_seller_settings
            ...
            self.csgoempire_site_url = f"https://{self.get_key(self.csgoempire_settings_general, 'url')}"
            ...
            self.csgoempire_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.csgoempire_saleprice_bot_name = self.get_key(self.csgoempire_settings_general, 'saleprice bot name')
        ...
        # region Collection csgo500_seller_settings
            ...
            self.csgo500_site_url = f"https://{self.get_key(self.csgo500_settings_general, 'url')}"
            ...
            self.csgo500_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.csgo500_saleprice_bot_name = self.get_key(self.csgo500_settings_general, 'saleprice bot name')
        ...
        # region Collection shadowpay_seller_settings
            ...
            self.shadowpay_site_url = f"https://{self.get_key(self.shadowpay_settings_general, 'url')}"
            ...
            self.shadowpay_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.shadowpay_saleprice_bot_name = self.get_key(self.shadowpay_settings_general, 'saleprice bot name')
        ...
        # region Collection buff_seller_settings
            ...
            self.buff_site_url = f"https://{self.get_key(self.buff_settings_general, 'url')}"
            self.buff_site_cookie_global_time = self.get_key(self.buff_settings_general, 'site cookie global time')
            self.buff_balance_transfer_global_time = self.get_key(self.buff_settings_general, 'balance transfer global time')
            self.buff_site_name = self.get_key(self.tm_settings_general, 'site name')
            self.buff_saleprice_bot_name = self.get_key(self.buff_settings_general, 'saleprice bot name')
