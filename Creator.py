...
if __name__ == '__main__':
    try:
        ...
        time.sleep(mongo.creator_sleep_between_threads)
        try:
            steam_inventory_thread = threading.Thread(target=steam_inv.work_with_steam_data,
        ...
        time.sleep(mongo.creator_sleep_between_threads)
        try:
            steam_api_key_thread = threading.Thread(target=steam_api.work_with_steam_data,
        ...
        try:
            ...
            steam_access_token_thread = threading.Thread(target=steam_acs.work_with_steam_data,
